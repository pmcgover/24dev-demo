...
s.id_species s_id_species,
s.species s_species_name,
e.id_epithet e_id_epithet,
e.epithet e_epithet,
e.species_id e_species_id,
...
ipc_salix_family f
WHERE o.id_sorted = e.id_epithet
AND o.species_cleaned = s.species
AND e.family_id = f.id_family   
ORDER BY o.id_sorted;
...
CREATE VIEW vw1_all_ipc_salix_epithet_species_family AS 
SELECT  *
FROM ipc_salix_epithet e,
ipc_salix_species s,
ipc_salix_family f
WHERE e.species_id = s.id_species
AND e.family_id = f.id_family
...
from vw1_all_ipc_salix_epithet_species_family;

CREATE VIEW vw2_basic_ipc_salix_epithet_species_family AS 
SELECT
e.id_epithet  e_id_epithet,
...
f.father f_father,
f.is_root  f_is_root,
f.female_parent_species f_female_parent_species,
f.female_parent_clone f_female_parent_clone,
f.male_parent_species  f_male_parent_species,
f.male_parent_clone f_male_parent_clone
FROM ipc_salix_epithet e,
ipc_salix_species s,
ipc_salix_family f
WHERE e.species_id = s.id_species
...
select * from vw2_basic_ipc_salix_epithet_species_family
...
COUNT(DISTINCT(e_species_id)) unique_species,
...
FROM  vw2_basic_ipc_salix_epithet_species_family;
