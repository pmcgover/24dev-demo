...
#outFileName="/home/dad/r4st/bin/scripts/regressionTests/outputFiles/cindexer/Output-${baseInputFileName}"
outFileName="/home/dad/myGoogleDocs/Insync/Pat-Private/r4st/bin/scripts/competitionIndexer/output/Output-${baseInputFileName}"
