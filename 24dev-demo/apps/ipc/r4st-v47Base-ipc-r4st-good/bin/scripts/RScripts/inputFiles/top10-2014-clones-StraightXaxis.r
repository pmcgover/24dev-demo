#!/usr/bin/Rscript
# Conventional Bar chart with straight X axis labels

d1 <- read.csv(file="top10_vw_nursery_cuttings_2014.csv",head=T,sep=",")
...
png(filename="top10_vw_nursery_cuttings_2014.png", height=768, width=1024, bg="white")
