...
if (!$db_pass || (!$db_driver || !$db_server || !$db_name || !$db_user))
{
	...
	?>
		...
		<table class="ls ls2" cellspacing="1">
               <tr>
                        <th>Driver:</th>
                        <td><input type="text" name="db_driver" value="pgsql"></td>
                </tr>
                <tr>
                        <th>Server:</th>
                ...
                <tr>
                        <th>Database:</th>
                        <td><input type="text" name="db_name" value="r4p"></td>
                </tr>
                <tr>
                        <th>User:</th>
                        <td><input type="text" name="db_user" value="user"></td>
                </tr>
		<tr>
			<th>Password:</th>
			<td><input type="password" name="db_pass" value="user"></td>
		</tr>
		<tr>
			<th>Db charset:</th>
